...
// this class implements the functional interface MyNumber
public class LambdaDemo {
    ...
    public static void main(String[] args) {
        ...
        // When it is assigned to myNum, a class instance is constructed in which the lambda
        ...
        // myNum = () -> "123.03"; // Error because we are passing string parameter to double taking method.
